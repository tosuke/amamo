import { useState, unstable_useTransition as useTransition, Suspense, useMemo, useEffect, TimeoutConfig } from 'react';
...
const SUSPENSE_CONFIG: TimeoutConfig = { timeoutMs: 1500 };
